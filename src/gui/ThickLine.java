// ref 2021 https://www.rgagnon.com/javadetails/java-0260.html
...
public class ThickLine extends Applet {
	...
	public void paint( Graphics g ) {
		...
		drawThickLine(g, getSize().width/2, 0, getSize().width/2, getSize().height, 8, new Color(0).green);
		drawThickLine(g, 0, getSize().height/2, getSize().width, getSize().height/2, 12,new Color(0).blue);
	}
